    ...
    <div class="flex-container">
        ...
        <div class="about_me">
          ...
          <h1>  <?php  echo $p  ?> </h1>
            ...
            <div class="data">
                <div class="myImg">
                    <?php  echo '<img src="https://w1.pngwing.com/pngs/762/217/png-transparent-mysql-logo-lamp-apache-http-server-computer-servers-linux-installation-php-web-server-thumbnail.png">'; ?>                    
                </div>
